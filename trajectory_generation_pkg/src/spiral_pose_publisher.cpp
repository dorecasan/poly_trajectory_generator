...
int main(int argc, char** argv) {
    ...
    ros::Publisher posePublisher = nh.advertise<geometry_msgs::PoseArray>("/desired_traj_vertices", 10,true);
    ros::Publisher posePublisher1 = nh.advertise<geometry_msgs::PoseArray>("/desired_traj_vertices1", 10,true);
    ...
    while(ros::ok()){
        r.sleep();
        posePublisher1.publish(poseArray);
        ROS_INFO("Published");
    }
